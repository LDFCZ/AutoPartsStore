...
import ru.nsu.ccfit.lopatkin.store.common.exception.NoFileFoundException;
...
public class FileRepository {
    ...
    public GridFsResource getResource(ObjectId id) {
        ...
        throw new NoFileFoundException("No file with id: " + id.toHexString());
    }
    ...
    public GridFsResource getResource(String fileName) {
        ...
        throw new NoFileFoundException("No file with fileName: " + fileName);
    }
